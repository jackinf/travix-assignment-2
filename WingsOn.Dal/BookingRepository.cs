...
namespace WingsOn.Dal
{
    public class BookingRepository : RepositoryBase<Booking>, IBookingRepository
    {
        ...
        public Booking GetByFlightNumber(string flightNumber)
        {
            return GetAll()
                .FirstOrDefault(x => !string.IsNullOrWhiteSpace(x.Flight?.Number)
                     && string.Equals(x.Flight?.Number, flightNumber,
